...
(function (root) {
  ...
  function card(state) {
    ...
    return '<div class="' + cls.join(' ') + '"><div class="signal-top"><div class="row">'
      ...
      + '<div class="headline" style="margin-top:8px"><div><span class="str-l">Signal strength</span><span class="str-v">' + s.strength.toFixed(1) + '</span></div><div class="prob">est. probability <b>' + C.pct(s.probEst) + '</b> vs 10% base</div></div></div></div>'
